...
R: Como testamos o nível de associação de variáveis categóricas, vamos usar o teste qui-quadrado. Nós vemos no resultado que o p-value é menor que o nível de significância 0,05 e que temos um alto valor para o qui-quadrado. Portanto, rejeitamos a hipóstese nula e concluimos que a renda e a cor/raça têm uma associação significante.
